  ...
  return (
    <div className="section  bg-gradient ">
      <div className="container mx-auto center min-h-screen">
        <div className="flex items-center gap-[20px] ltr:flex-row-reverse">
          {loading ? (
            ...
            <>
              ...
              <Image
                data-aos="zoom-in"
                className="object-contain max-sm:w-[150px] max-sm:h-[50px]"
        ...
        {loading ? (
          <div className="h-8 !w-full !max-w-[550px]  mx-auto mt-[10px] rounded skeleton-box bg-white/20" />
        ) : (
          <Title
            title={data?.title?.[locale]}
            cn="text24 !px-[40px] text-white text-center"
          />
        )}
        ...
        {loading ? (
          <div>
            {" "}
            <div className="h-10 w-[180px]  mx-auto mt-[10px] rounded skeleton-box bg-white/20" />{" "}
          </div>
        ) : (
